...
baseUrl = raw_input('enter url (https://nl.hardware.info) : ')
loginUrl = baseUrl + raw_input('enter loginUrl (/forum/) : ')
profileUrl = baseUrl + raw_input('enter profileUrl (/forum/login/login) : ')
